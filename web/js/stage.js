...
(function () {
  ...
  const S = (CLIQ.stage = {
    ...
    fxFor(e) {
      return CLIQ.fxFor(e); // shared routing (js/fxmap.js), used by the WebGL stage too
    },
  ...
  CLIQ.stageDOM = S; // stable handle to the DOM renderer; the WebGL stage falls back to it
})();
